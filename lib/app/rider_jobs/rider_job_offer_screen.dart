      ...
      builder: (context, snapshot) {
        ...
        if (terminal == 'cancelled' ||
          ...
          return _StateScaffold(
              ...
              message:
                  'This delivery can no longer progress. The latest status has been restored.');
        }
            ...
            return RiderGlassSurface(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    'Waiting time stays accurate if you leave this screen and return later.',
                    style: TextStyle(
    ...
    final service = healthPlus
        ...
        : vanguard
            ...
            : gift
                ? 'Gift'
                : 'Standard';
    return '$service verification: ${methods.join(', ')}. CIRCUM sets these requirements for this delivery.';
  }
}
